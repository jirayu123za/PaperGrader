  ...
  useEffect(() => {
    if (member) {
      ...
      const sections = member.section_name
        ? member.section_name.includes(',') // ตรวจสอบว่า Section มีหลายค่า
          ? member.section_name.split(',') // แยก Sections
          : [member.section_name] // เก็บเป็นอาร์เรย์
        : ['All Sections']; // ถ้า Section เป็น null หรือ undefined
