...
import CreateOutline from '../../../../../../../../../components/INS/INSProcess/Right/Grading';
...
export default function CreateOutlinePage() {
    ...
    useEffect(() => {
        const loadPdfFromPublic = () => {
            // เปลี่ยนเส้นทางไฟล์ PDF ให้ชี้ไปยังไฟล์ใน public
            const pdfPath = '/pdf/test01.pdf'; // ตัวอย่างไฟล์ PDF ที่อยู่ใน public/pdf
            ...
            >
                {form.values.loading ? (
                    ...
                    <PDFViewer
                        ...
                        updateBoundingBox={() => { }} // ไม่ต้องการอัปเดต
                        setBoundingBoxes={() => { }} // ไม่ต้องการเซ็ตใหม่
                        readOnly={true}
                    />
                ) : (
