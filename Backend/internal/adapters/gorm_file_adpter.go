...
func (r *FileRepository) SaveFile(file *models.File, fileContent io.Reader) error {
...
func (r *FileRepository) FindFileByID(fileName string) (*models.File, error) {
	ctx := context.Background()
...
func (r *FileRepository) RemoveFile(file *models.File) error {
	ctx := context.Background()
...
func (r *FileRepository) FindFileURL(fileName string) (string, error) {
	ctx := context.Background()
